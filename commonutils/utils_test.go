...
func TestUnixNesc(t *testing.T) {
	t.Parallel()
	i := int64(1532246192000)
	_time := TimeFromUnixNEscInt64(i)
	fmt.Println(_time.Format("2006-01-02 15:04:05")) //2018-07-22 15:56:32
	fmt.Println(UnixNesc(_time))                     // 1532246192000
}

func TestTimeFromUnixNEscInt64(t *testing.T) {
	t.Parallel()
	i := int64(1530854162)
